...
class DotLivePlotter(QtGui.QMainWindow): #, dotx, doty, stagex, stagey):
    def __init__(self, parent=None):
        ...
        self.login_widget.button.clicked.connect(self.plotter) #TODO just initiate self plotter here
    ...
    def updater(self):
        self.t = self.t + 1
        self.x = [np.sin(.002 * self.t)] # feed data in here
        self.y = [np.cos(.002* self.t)]
