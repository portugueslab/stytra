...
#         self.motor_x.movesimple(pos_x + 20000)  # 20000 motor units is 1 mm
#         sleep(0.5)
#         pos_y = self.motor_y.get_position()
#         self.motor_y.movesimple(pos_y + 20000)  # 20000 motor units is 1 mm
#         sleep(0.5)
...
#         self.center_x = self.motor_y.get_position()
#         self.center_y = self.motor_x.get_position()
#         self.stepsize = int(
#             200000
...
#         self.motor_posx = self.motor_x.get_position()
#         self.motor_posy = self.motor_y.get_position()
